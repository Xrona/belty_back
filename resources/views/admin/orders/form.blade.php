        ...
        <div class="border p-3">
            ...
            <div class="border p-3 mb-4">
                ...
                <div class="form-group {{ $errors->has('product_name') ? 'has-error' : ''}}">
                    ...
                    <input class="form-control" name="products[{{$key}}][product_name]" type="text" value="{{ $product?->product_name ?? ''}}">
                    {!! $errors->first('product_name', '<p class="help-block">:message</p>') !!}
                </div>
                <div class="form-group {{ $errors->has('buy_price') ? 'has-error' : ''}}">
                    <label for="buy_price" class="control-label">Buy price</label>
                    <input class="form-control" name="products[{{$key}}][buy_price]" type="text" value="{{ $product?->buy_price ?? ''}}">
                    {!! $errors->first('buy_price', '<p class="help-block">:message</p>') !!}
                </div>
                <div class="form-group {{ $errors->has('count') ? 'has-error' : ''}}">
                    <label for="count" class="control-label">Count</label>
                    <input class="form-control" name="products[{{$key}}][count]" type="text" value="{{ $product?->count ?? ''}}">
                    {!! $errors->first('count', '<p class="help-block">:message</p>') !!}
                </div>
                <label for="color">Color</label>
                <div class="form-group {{ $errors->has('color') ? 'has-error' : ''}}">
                    <select name="products[{{$key}}][color]" class="select2 w-25">
                        @if($product->product)
                ...
                <div class="form-group {{ $errors->has('size') ? 'has-error' : ''}}">
                    <select name="products[{{$key}}][size]" class="select2 w-25">
                        @if($product->product)
                ...
                <div class="form-group {{ $errors->has('is_gift') ? 'has-error' : ''}}">
                    <input type="checkbox" name="products[{{$key}}][is_gift]" {{$product->is_gift ? 'checked' : ''}}>
                ...
                <div class="form-group {{ $errors->has('engraving') ? 'has-error' : ''}}">
                    ...
                    <input class="form-control" name="products[{{$key}}][engraving]" type="text" value="{{ $product?->engraving ?? ''}}">
